...
> Scraped on: 2026-03-30 | Root Source: [https://argo-cd.readthedocs.io/](https://argo-cd.readthedocs.io/)
...
The `--server-side --force-conflicts`

flags are required due to CRD size limitations. See the [getting started guide](getting_started/) for details.

Follow our [getting started guide](getting_started/). Further user oriented [documentation](user-guide/)
is provided for additional features. If you are looking to upgrade Argo CD, see the [upgrade guide](operator-manual/upgrading/overview/).
...
[kustomize](https://kustomize.io)applications[helm](https://helm.sh)charts[jsonnet](https://jsonnet.org)files- Plain directory of YAML/json manifests
...
manifests at a Git commit. See [tracking strategies](user-guide/tracking_strategies/) for additional
...
For additional details, see [architecture overview](operator-manual/architecture/).
